...
#define     VPOST_WIDTH     1024
#define     VPOST_HEIGHT    600
...
void fillRect(UINT32 u32BufAddr, UINT32 s_x, UINT32 s_y,UINT32 Width, UINT32 Height, E_DRVBLT_DISPLAY_FORMAT eDestFmt,UINT8 u8R, UINT8 u8G, UINT8 u8B, UINT8 u8A);
