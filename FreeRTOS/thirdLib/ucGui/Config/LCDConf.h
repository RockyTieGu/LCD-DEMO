...
#define LCD_XSIZE      (_LCD_WIDTH)   /* X-resolution of LCD, Logical coor. */
#define LCD_YSIZE      (_LCD_HEIGHT)   /* Y-resolution of LCD, Logical coor. */

//#define LCD_BITSPERPIXEL (8)
#define LCD_BITSPERPIXEL (LCD_BITS_MODE)
