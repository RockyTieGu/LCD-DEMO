...
extern int i2cOpen(void);
extern int i2cClose(void);
extern int i2cRead(unsigned char * buf, unsigned int len);
extern int i2cRead_OV(unsigned char * buf, unsigned int len);
extern int i2cWrite(unsigned char * buf, unsigned int len);
extern int i2cIoctl(unsigned int cmd, unsigned int arg0, unsigned int arg1);
extern int i2cExit(void);
